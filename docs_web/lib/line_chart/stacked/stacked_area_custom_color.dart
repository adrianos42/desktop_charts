...
class StackedAreaCustomColorLineChartBuilder extends ExampleBuilder {
  const StackedAreaCustomColorLineChartBuilder();

  @override
  String? get subtitle => StackedAreaCustomColorLineChart.subtitle;

  @override
  String get title => StackedAreaCustomColorLineChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      StackedAreaCustomColorLineChart.withSampleData(animate);
...
class StackedAreaCustomColorLineChart extends StatelessWidget {
  ...
  static String get title => 'Area Custom Color';
