...
class LineRangeAnnotationMarginChartBuilder extends ExampleBuilder {
  const LineRangeAnnotationMarginChartBuilder();

  @override
  String? get subtitle => LineRangeAnnotationMarginChart.subtitle;

  @override
  String get title => LineRangeAnnotationMarginChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      LineRangeAnnotationMarginChart.withSampleData(animate);
