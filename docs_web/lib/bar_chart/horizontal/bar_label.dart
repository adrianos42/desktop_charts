...
class HorizontalBarLabelChartBuilder extends ExampleBuilder {
  const HorizontalBarLabelChartBuilder();

  @override
  String? get subtitle => HorizontalBarLabelChart.subtitle;

  @override
  String get title => HorizontalBarLabelChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      HorizontalBarLabelChart.withSampleData(animate);
  ...
  @override
  dynamic generateRandomData() => HorizontalBarLabelChart.createRandomData();
...
class HorizontalBarLabelChart extends StatelessWidget {
  ...
  static String get title => 'Labels';
