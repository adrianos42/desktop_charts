...
class StackedBarTargetLineChartBuilder extends ExampleBuilder {
  const StackedBarTargetLineChartBuilder();

  @override
  String? get subtitle => StackedBarTargetLineChart.subtitle;

  @override
  String get title => StackedBarTargetLineChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      StackedBarTargetLineChart.withSampleData(animate);
  ...
  @override
  dynamic generateRandomData() => StackedBarTargetLineChart.createRandomData();
...
class StackedBarTargetLineChart extends StatelessWidget {
  ...
  static String get title => 'Target Line';
