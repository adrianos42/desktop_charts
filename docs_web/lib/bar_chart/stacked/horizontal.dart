...
class StackedHorizontalBarChartBuilder extends ExampleBuilder {
  const StackedHorizontalBarChartBuilder();

  @override
  String? get subtitle => StackedHorizontalBarChart.subtitle;

  @override
  String get title => StackedHorizontalBarChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      StackedHorizontalBarChart.withSampleData(animate);
  ...
  @override
  dynamic generateRandomData() => StackedHorizontalBarChart.createRandomData();
...
class StackedHorizontalBarChart extends StatelessWidget {
  ...
  factory StackedHorizontalBarChart.withSampleData([bool animate = true]) {
  ...
  static String get title => 'Stacked';
