...
class GroupedFillColorBarChartBuilder extends ExampleBuilder {
  const GroupedFillColorBarChartBuilder();

  @override
  String? get subtitle => GroupedFillColorBarChart.subtitle;

  @override
  String get title => GroupedFillColorBarChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      GroupedFillColorBarChart.withSampleData(animate);
  ...
  @override
  dynamic generateRandomData() => GroupedFillColorBarChart.createRandomData();
