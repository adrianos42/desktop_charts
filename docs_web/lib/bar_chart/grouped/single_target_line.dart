...
class GroupedBarSingleTargetLineChartBuilder extends ExampleBuilder {
  const GroupedBarSingleTargetLineChartBuilder();

  @override
  String? get subtitle => GroupedBarSingleTargetLineChart.subtitle;

  @override
  String get title => GroupedBarSingleTargetLineChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      GroupedBarSingleTargetLineChart.withSampleData(animate);
...
class GroupedBarSingleTargetLineChart extends StatelessWidget {
  ...
  static String get title => 'Single Target Line';
