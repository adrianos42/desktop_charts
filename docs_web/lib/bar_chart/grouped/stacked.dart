...
class GroupedStackedBarChartBuilder extends ExampleBuilder {
  const GroupedStackedBarChartBuilder();

  @override
  String? get subtitle => GroupedStackedBarChart.subtitle;

  @override
  String get title => GroupedStackedBarChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      GroupedStackedBarChart.withSampleData(animate);
  ...
  @override
  dynamic generateRandomData() => GroupedStackedBarChart.createRandomData();
...
class GroupedStackedBarChart extends StatelessWidget {
  ...
  factory GroupedStackedBarChart.withSampleData([bool animate = true]) {
