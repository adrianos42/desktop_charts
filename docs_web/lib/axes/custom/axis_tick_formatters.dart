...
class CustomAxisTickFormattersBuilder extends ExampleBuilder {
  const CustomAxisTickFormattersBuilder();

  @override
  String? get subtitle => CustomAxisTickFormatters.subtitle;

  @override
  String get title => CustomAxisTickFormatters.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      CustomAxisTickFormatters.withSampleData(animate);
  ...
  @override
  dynamic generateRandomData() => CustomAxisTickFormatters.createRandomData();
...
class CustomAxisTickFormatters extends StatelessWidget {
  ...
  static String get title => 'Formatter';
