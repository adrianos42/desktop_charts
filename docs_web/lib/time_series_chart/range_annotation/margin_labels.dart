...
class TimeSeriesRangeAnnotationMarginChartBuilder extends ExampleBuilder {
  const TimeSeriesRangeAnnotationMarginChartBuilder();

  @override
  String? get subtitle => TimeSeriesRangeAnnotationMarginChart.subtitle;

  @override
  String get title => TimeSeriesRangeAnnotationMarginChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      TimeSeriesRangeAnnotationMarginChart.withSampleData(animate);

  @override
  Widget withData(dynamic data, [bool animate = true]) =>
      TimeSeriesRangeAnnotationMarginChart(
  ...
  dynamic generateRandomData() =>
      TimeSeriesRangeAnnotationMarginChart.createRandomData();
...
class TimeSeriesRangeAnnotationMarginChart extends StatelessWidget {
  ...
  static String get title => 'Margin Labels';
