...
class SimpleTimeSeriesRangeAnnotationChartBuilder extends ExampleBuilder {
  const SimpleTimeSeriesRangeAnnotationChartBuilder();

  @override
  String? get subtitle => SimleTimeSeriesRangeAnnotationChart.subtitle;

  @override
  String get title => SimleTimeSeriesRangeAnnotationChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      SimleTimeSeriesRangeAnnotationChart.withSampleData(animate);

  @override
  Widget withData(dynamic data, [bool animate = true]) =>
      SimleTimeSeriesRangeAnnotationChart(
  ...
  dynamic generateRandomData() =>
      SimleTimeSeriesRangeAnnotationChart.createRandomData();
...
class SimleTimeSeriesRangeAnnotationChart extends StatelessWidget {
  const SimleTimeSeriesRangeAnnotationChart(
    this.seriesList, {
    this.animate = true,
    super.key,
  });
  ...
  factory SimleTimeSeriesRangeAnnotationChart.withSampleData([
    bool animate = true,
  ]) {
    return SimleTimeSeriesRangeAnnotationChart(
      createSampleData(),
      animate: animate,
    );
  }
