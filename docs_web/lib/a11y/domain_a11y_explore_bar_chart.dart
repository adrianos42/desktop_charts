...
class DomainA11yExploreBarChart extends StatelessWidget {
  ...
  factory DomainA11yExploreBarChart.withSampleData([bool animate = true]) {
  ...
  factory DomainA11yExploreBarChart.withRandomData([bool animate = true]) {
    return DomainA11yExploreBarChart(
      createRandomData(),
      animate: animate,
    );
  ...
  String vocalizeDomainAndMeasures(List<charts.SeriesDatum> seriesDatums) {
    ...
    for (final charts.SeriesDatum seriesDatum in seriesDatums) {
