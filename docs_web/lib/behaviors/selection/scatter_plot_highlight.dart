...
class SelectionScatterPlotHighlightBuilder extends ExampleBuilder {
  const SelectionScatterPlotHighlightBuilder();

  @override
  String? get subtitle => SelectionScatterPlotHighlight.subtitle;

  @override
  String get title => SelectionScatterPlotHighlight.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      SelectionScatterPlotHighlight.withSampleData(animate);
  ...
  dynamic generateRandomData() =>
      SelectionScatterPlotHighlight.createRandomData();
...
/// value referenced by [charts.pointSymbolRendererKey].
///
...
class SelectionScatterPlotHighlight extends StatelessWidget {
  ...
  factory SelectionScatterPlotHighlight.withSampleData([bool animate = true]) {
  ...
  static String get title => 'Scatter Plot Highlight';
  static String? get subtitle =>
      'Scatter plot chart with tap and drag activation';
  ...
  static List<charts.Series<LinearSales, int>> createSampleData() {
    final data = [
      ...
      // Render a hollow circle, filled in with white.
      LinearSales(
          45, 300, 8.0, 'circle', charts.DesktopPalette.foreground, 2.0),
