...
class PercentOfDomainByCategoryBarChartBuilder extends ExampleBuilder {
  const PercentOfDomainByCategoryBarChartBuilder();

  @override
  String? get subtitle => PercentOfDomainByCategoryBarChart.subtitle;

  @override
  String get title => PercentOfDomainByCategoryBarChart.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      PercentOfDomainByCategoryBarChart.withSampleData(animate);
  ...
  dynamic generateRandomData() =>
      PercentOfDomainByCategoryBarChart.createRandomData();
...
class PercentOfDomainByCategoryBarChart extends StatelessWidget {
  ...
  static String get title => 'Domain by Category';
