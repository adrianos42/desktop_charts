...
class DatumLegendWithMeasuresBuilder extends ExampleBuilder {
  const DatumLegendWithMeasuresBuilder();

  @override
  String? get subtitle => DatumLegendWithMeasures.subtitle;

  @override
  String get title => DatumLegendWithMeasures.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      DatumLegendWithMeasures.withSampleData(animate);

  @override
  Widget withData(dynamic data, [bool animate = true]) =>
      DatumLegendWithMeasures(
        data as List<charts.Series<dynamic, int>>,
        animate: animate,
      );

  @override
  dynamic generateRandomData() => DatumLegendWithMeasures.createRandomData();
    ...
    return charts.PieChart<int>(
      ...
      behaviors: [
        ...
        const charts.InitialSelection(
          selectedDataConfig: [charts.SeriesDatumConfig('Sales', 0)],
        ),
        charts.DatumLegend(
