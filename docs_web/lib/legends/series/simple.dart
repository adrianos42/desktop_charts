...
class SimpleSeriesLegendBuilder extends ExampleBuilder {
  const SimpleSeriesLegendBuilder();

  @override
  String? get subtitle => SimpleSeriesLegend.subtitle;

  @override
  String get title => SimpleSeriesLegend.title;

  @override
  Widget withSampleData([bool animate = true]) =>
      SimpleSeriesLegend.withSampleData(animate);

  @override
  Widget withData(dynamic data, [bool animate = true]) => SimpleSeriesLegend(
        data as List<charts.Series<dynamic, String>>,
        animate: animate,
      );

  @override
  dynamic generateRandomData() => SimpleSeriesLegend.createRandomData();
...
class SimpleSeriesLegend extends StatelessWidget {
  const SimpleSeriesLegend(
    this.seriesList, {
    this.animate = true,
    super.key,
  });

  factory SimpleSeriesLegend.withSampleData([bool animate = true]) {
