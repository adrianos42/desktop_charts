...
import '../chart_canvas.dart' show getAnimatedColor, FillPatternType;
...
abstract class BaseAnimatedBar<D, R extends BaseBarRendererElement> {
  ...
  /// Gets the state of the bar element for painting, updated for a
  /// transition between the previous state and the animationPercent.
