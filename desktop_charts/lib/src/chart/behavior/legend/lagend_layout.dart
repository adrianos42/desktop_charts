...
abstract class LegendLayout {
  ...
  Widget buildLegend(BuildContext context, List<Widget> legendEntryWidgets);
}
...
class TabularLegendLayout implements LegendLayout {
  ...
  @override
  Widget buildLegend(BuildContext context, List<Widget> legendEntries) {
  ...
  @override
  bool operator ==(covariant TabularLegendLayout value) =>
      desiredMaxRows == value.desiredMaxRows &&
      desiredMaxColumns == value.desiredMaxColumns &&
      isHorizontalFirst == value.isHorizontalFirst &&
