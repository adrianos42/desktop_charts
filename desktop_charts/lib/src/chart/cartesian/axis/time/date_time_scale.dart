...
class DateTimeScale extends MutableScale<DateTime> {
  ...
  @override
  double operator [](DateTime domainValue) =>
  ...
  void addDomain(DateTime domainValue) {
    _linearScale.addDomain(domainValue.millisecondsSinceEpoch.toDouble());
  }
  ...
  set viewportDomain(DateTimeExtents extents) {
    _linearScale.viewportDomain = NumericExtents(
      extents.start.millisecondsSinceEpoch.toDouble(),
      extents.end.millisecondsSinceEpoch.toDouble(),
    );
  }
  ...
  int compareDomainValueToViewport(DateTime domainValue) =>
      _linearScale.compareDomainValueToViewport(
        domainValue.millisecondsSinceEpoch.toDouble(),
      );
  ...
  @override
  bool canTranslate(DateTime domainValue) => _linearScale.canTranslate(
        domainValue.millisecondsSinceEpoch.toDouble(),
      );
