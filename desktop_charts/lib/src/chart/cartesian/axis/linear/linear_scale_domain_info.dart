...
class LinearScaleDomainInfo {
  ...
  double _dataDomainStart = double.infinity;
  double get dataDomainStart => _dataDomainStart;

  /// The maximum added domain value.
  double _dataDomainEnd = double.negativeInfinity;
  double get dataDomainEnd => _dataDomainEnd;
  ...
  bool extendDomain(num? domainValue) {
    ...
    if (domainValue < _dataDomainStart) {
      _dataDomainStart = domainValue.toDouble();
      domainExtended = true;
    }

    if (domainValue > _dataDomainEnd) {
      _dataDomainEnd = domainValue.toDouble();
      domainExtended = true;
    }
