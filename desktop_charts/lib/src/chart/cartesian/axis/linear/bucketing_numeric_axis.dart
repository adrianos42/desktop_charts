...
import '../spec/bucketing_axis_spec.dart' show BucketingAxisSpec;
...
class BucketingNumericAxis extends NumericAxis {
  BucketingNumericAxis({
    required BucketingAxisSpec axisSpec,
  ...
  void updateAxisSpec(AxisSpec<num> value) {
    ...
    if (value is BucketingAxisSpec) {
      if (value.threshold != null) {
        threshold = value.threshold!;
      }

      showBucket = value.showBucket;
    }
  }
