...
class BucketingAxisSpec extends NumericAxisSpec {
  ...
  BucketingAxisSpec({
    ...
    super.renderSpec,
    super.tickProviderSpec = const BucketingNumericTickProviderSpec(),
    super.showAxisLine,
  ...
  @override
  BucketingNumericAxis createAxis({
  ...
  @override
  int get hashCode => Object.hash(super.hashCode, showBucket, threshold);
}
