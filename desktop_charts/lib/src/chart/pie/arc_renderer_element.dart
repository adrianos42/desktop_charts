...
@immutable
class ArcRendererElements<D> {
  const ArcRendererElements({
    required this.arcs,
...
class AnimatedArc<D> {
  ...
  /// Returns the [startAngle] of the target element, without updating
  /// animation state.
  double? get newTargetArcStartAngle => _targetArc.startAngle;

  /// Returns the [endAngle] of the target element, without updating
  /// animation state.
